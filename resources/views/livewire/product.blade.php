<div>
    <div>
        ...
        <head>
            <title>
                {{ $product->name }} - {{ $product->category->name }} - AN AN MART
            </title>
            ...
            <span itemscope itemtype='http://schema.org/Product'>
                ...
                <span itemprop='offers' itemscope itemtype='http://schema.org/Offer'>
                    ...
                    <link itemprop='availability' href='http://schema.org/{{ $product->is_stock == 0 ? 'OutOfStock' : 'InStock' }}' />
                </span>
            </span>
                ...
                <div class="scroller">
                    ...
                    <div class="scroller-inner">
                        ...
                        <main class="padding-top-mobile">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li><a href="/shop?cat={{ $product->category->id }}" target="_self">{{ $product->category->name }}</a></li>

                                                <li><i class="fa fa-angle-right"></i></li>
                                                <li class="active"><span>{{ $product->name }}</span>
                                                </li>
                            ...
                            <div class="container">
                                <div class="row">
                                  @livewire('content.product', ['product' => $product, 'relatedProducts' => $relatedProducts])
