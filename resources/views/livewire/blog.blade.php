                                                    ...
                                                    <ul class="col-xs-12 blog-list-articles lists-articles 7"
                                                        ...
                                                        <li class="clearfix">
                                                            <div class="blog-item-image">
                                                                ...
                                                                <a href="{{ url('/blog/' . $blog->slug) }}"><img src="{{ url(Storage::url($blog->banner)) }}" alt="{{ $blog->title }}"></a>
                                                            ...
                                                            <div class="blog-item-title">
                                                                ...
                                                                <p>
                                                                    Ngày:{{ $blog->created_at->format('d/m/Y') }} lúc {{ $blog->created_at->format('H:i') }}
                                                                </p>
                                                                <div class="blog-content-short-description"> {{ Str::limit($blog->short_description, 300) }} </div>
                                                            </div>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                <div class="blog-sidebar">
                                                    ...
                                                    <ul class="blog-list-articles">
                                                        ...
                                                        <li class="clearfix">
                                                            <div class="blog-item-image">
                                                                <a href="/blog/{{ $newBlog->slug }}"
                                                                    title="{{ $newBlog->title }}">
                                                                    <img src="{{ url(Storage::url($newBlog->banner)) }}"
                                                                        alt="{{ $newBlog->title }}" />
                                                            ...
                                                            <div class="blog-item-title">
                                                                ...
                                                                <p>
                                                                    Ngày:{{ $newBlog->created_at->format('d/m/Y') }} lúc {{ $newBlog->created_at->format('H:i') }}
                                                                </p>
                                                            </div>
                                                        </li>
                                                        @endforeach
