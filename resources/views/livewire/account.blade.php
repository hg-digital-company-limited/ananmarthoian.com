                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h1>
                                                Tài khoản của bạn
                                                <a class="logout" wire:click="logout" style="cursor: pointer;">
                                        ...
                                        <div id="customer_sidebar" class="col-md-4 col-xs-12">
                                            <div class="userbox">
                                                ...
                                                <p class="email"><span>Email</span>: {{ $user->email }}</p>
                                                <div class="address">
                                                    <p><span>Địa chỉ</span>: {{ $user->address }}</p>
                                                    <p><span>Điện thoại</span>: {{ $user->phone }}</p>
                                                </div>
                                                <div class="text-right">
                                                    <a id="view_address" href="/account/addresses">Xem địa chỉ <i class="fa fa-share"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
