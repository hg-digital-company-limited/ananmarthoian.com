        ...
        <div>
            ...
            <head>
                ...
                <script src='/assets/theme.hstatic.net/200000077081/1001259549/14/script.js?v=168'
                    type='text/javascript'></script>
                <!-- css -->
                <link href='/assets/hstatic.net/0/global/design/css/font-awesome.min.css' rel='stylesheet'
                    ...
                    <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                        <div class="scroller-inner">
                            ...
                            <main class="padding-top-mobile">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb breadcrumb-arrow">
                                                    ...
                                                    <li><i class="fa fa-angle-right"></i></li>
                                                    <li><a href="/account" target="_self">Lịch sử đơn hàng :</a></li>
                                                    <li class="active"><span>#104033</span></li>
                                ...
                                <section class="layout-info-account order-account">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <h1>
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <div id="order_details" class="userbox">
                                                    <table>
                                                        <thead>
                                                            <tr>
                                                                <th>Sản phẩm</th>
