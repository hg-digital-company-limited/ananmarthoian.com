                ...
                <div class="scroller">
                    ...
                    <div class="scroller-inner">
                        ...
                        <main>
                          ...
                          @livewire('content.home.product',['newestProducts' => $newestProducts,'bestSellingProducts' => $bestSellingProducts,'latestBlogs' => $latestBlogs])
                                                                ...
                                                                @foreach($latestBlogs as $blog)
                                                                    <div class="blog-item item article-resize">
                                                                        <div class="image-blog image-article-resize">
                                                                            <img src="{{Storage::url($blog->banner) }}"
                                                                                alt="{{ $blog->title }}">
                                                                        </div>
                                                                        <div class="content-blog clearfix">
                                                                            <div class="time-blog">
                                                                                <div class="w-time">
                                                                                    <span
                                                                                        class="d-day">{{ $blog->created_at->format('d') }}</span>
                                                                                    <span class="hr"></span>
                                                                                    <span
                                                                                        class="d-month">{{ $blog->created_at->format('m') }}</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="desc-blog">
                                                                                <h4 class="postTitle">
                                                                                ...
                                                                                <div class="trunc-blog">
                                                                                    <p>{{ Str::limit($blog->short_description, 100) }}
                                                                                    </p> <!-- Giới hạn độ dài nội dung -->
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
