        ...
        <div>
            <div>
                ...
                <head>
                    ...
                    <title>Khóa Học Miễn Phí - KhoaHocMienPhi.Site</title>
                </head>
                ...
                <body class="darkmode">
                        ...
                        <div class="menu-open-left">
                            <div class="menu-open-content-mobile">
                                <div class="close"><label for="check-menu-mobile"><iconify-icon icon="ic:round-close"
                                            ...
                                            style="margin-top: 1px;"></iconify-icon></i></label></div>
                    ...
                    <div class="home-hero">
                        <div class="hero-background-img">
                            <img src="https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/d0c66d48-9b00-4a12-b436-d897f2c6d600/w=1080"
                                srcset="https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/d0c66d48-9b00-4a12-b436-d897f2c6d600/w=600 600w,
                                                             https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/d0c66d48-9b00-4a12-b436-d897f2c6d600/w=800 800w,
                                                             https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/d0c66d48-9b00-4a12-b436-d897f2c6d600/w=1080 1080w"
                                sizes="(max-width: 600px) 600px, (max-width: 1200px) 800px, 1080px"
                                alt="Khóa học miễn phí - Share khóa học online free"
                                style="width: 100%;height: 100%;object-fit: cover;">
                        </div>
                        <div class="hero-content-background">
                            <div class="hero-content-container container">
                                <div class="hero-text-container">
                                    <h1 class="hero-title">Chia sẻ khóa học<br>Lan tỏa tri thức</h1>
                                    <p class="hero-sub-title">Chia sẻ khóa học online miễn phí hoặc share với học phí
                                        thấp. Nhưng nếu có
                                        điều kiện, bạn hãy mua khóa học trực tiếp để ủng hộ giảng viên nhé!</p>
                                    <div class="hero-btn-wrapper">
                                        <a href="/login" class="btn-secondary"
                                            style="color: #FFFFFF; border-color: #FFFFFF;">Yêu cầu khóa học mới</a>
                                        <a href="#start-learning" class="btn-primary">Bắt đầu học</a>
                                    </div>
                                </div>
                                <div class="hero-category-column d-none d-lg-flex">
                                      <div class="hero-category-wrapper">
                                        @foreach ($categories as $category)
                                        <a href="/shop?category={{ $category->name }}"
                                            class="cate-candy">{{ $category->name }}</a>
                                        @endforeach
                        ...
                        <div class="home-reasons-wraper">
                            <svg class="editorial" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g class="parallax1" opacity="0.4">
                                    <use xlink:href="#gentle-wave" x="50" y="3" fill="#454963" />
                                </g>
                                <g class="parallax2" opacity="0.5">
                                    <use xlink:href="#gentle-wave" x="50" y="0" fill="#454963" />
                                </g>
                                <g class="parallax3" opacity="0.8">
                                    <use xlink:href="#gentle-wave" x="50" y="7" fill="#454963" />
                                </g>
                                <g class="parallax4" opacity="0.2">
                                    <use xlink:href="#gentle-wave" x="50" y="6" fill="#454963" />
                                </g>
                            </svg>

                            <div class="home-reasons-wraper-rectangle">
                                <div class="container">
                                    <div class="row g-2" style="margin-top:0px">
                                        <div class="col-12 d-block d-lg-none">
                                            <div class="category-mobile-wraper">
                                                <div class="container">
                                                    <div class="row g-0">
                                                        <div class="category-single col-3 col-sm-2 col-lg-1">
                                                            <a href="/shop"
                                                                style="display: inline">
                                                                <img src="/asset/img/download.png" alt="Danh sách tất cả khóa học">
                                                            </a>
                                                            <span>
                                                                <a href="/shop">
                                                                    <p class="category-title">Tất cả khóa học</p>
                                                        ...
                                                        <div class="category-single col-3 col-sm-2 col-lg-1">
                                                            <a href="/shop?category={{ $category->name }}"
                                                                style="display: inline">
                                                                <img src="{{ Storage::url($category->image_link) }}"
                                                                    alt="{{ $category->name }}">
                                                            </a>
                                                            <span>
                                                                <a href="/shop?category={{ $category->name }}">
                                        ...
                                        <div class="col-lg-3 d-none d-lg-block">
                                            <div class="reason">
                                                <img src="https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/5reputation.png/w=70"
                                                    alt="uy tín chất lượng">
                                                <div class="reason-text-wraper">
                                                    <h4><strong>Uy Tín Chất Lượng</strong></h4>
                                                    <p>Hoàn tiền nếu khóa học không giống mô tả</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 d-none d-lg-block">
                                            <div class="reason">
                                                <img src="https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/update.png/w=70"
                                                    alt="update khóa học">
                                                <div class="reason-text-wraper">
                                                    <h4><strong>Update Liên Tục</strong></h4>
                                                    <p>Cập nhật 10 - 15 khóa hàng tuần</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 d-none d-lg-block">
                                            <div class="reason">
                                                <img src="https://imagedelivery.net/aXueHOobW3aL_CnLPhCXPw/fast-time.png/w=70"
                                                    alt="khóa học kích hoạt nhanh">
                                                <div class="reason-text-wraper">
                                                    <h4><strong>Kích Hoạt Ngay</strong></h4>
                                                    <p>Kích hoạt khóa tự động ngay lập tức 24/7</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="course-list-wraper container">
                        <h2 class="trending_course">Top 10 Khóa Học Hot</h2>
                        ...
                        <div class="show-more btn-primary d-none d-lg-block">Xem thêm</div>

                    </div>
                    <div class="course-list-wraper container">
                        <h2 class="newest_course">Các Khóa Học Mới Nhất</h2>
                        <div class="course-list row g-2">
                    ...
                    <div class="course-list-wraper container">
                        <h2 class="personal_course">Khóa Học Phù Hợp Nhất</h2>
                        <div class="course-list row g-2">
                    ...
                    <div class="course-list-wraper container">
                        ...
                        <p style="margin-top: 32px;">{{ $category->description }}</p>
                        Từ xây dựng ý tưởng đến thu hút vốn đầu tư, kiểm soát dòng tiền, doanh thu,.. mỗi khóa học
                        <div class="course-list row g-2">
                            @php
                                // Lấy 5 sản phẩm cho mỗi danh mục
                                $filteredProducts = $products->filter(function ($product) use ($category) {
                        ...
                        <a href="/shop?category={{ $category->name }}" class="show-more btn-primary d-none d-lg-block">Xem thêm</a>
                    </div>
                @endforeach --}}
