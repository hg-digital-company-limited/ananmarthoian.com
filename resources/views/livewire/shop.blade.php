        ...
        <div>
            <div>
                ...
                <head>
                    ...
                    <title>Danh Sách Khóa Học Miễn Phí - KhoaHocMienPhi.Site</title>
                </head>
                ...
                <body class="darkmode">
                    ...
                    <div class="col-md-6" id="search-mobile-input">
                        <div class="textbox-wraper search">
                            <form action="/shop" method="get">
                                <input spellcheck="false" class="textbox-comp search-input" name="search" id=""
                        ...
                        <div class="container">
                            <div class="row g-0">
                                <div class="category-single col-3 col-sm-2 col-lg-1">
                                    <a href="/shop" style="display: inline">
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    <div class="category-single col-3 col-sm-2 col-lg-1">
                                        <a href="/shop?category={{ $category->name }}" style="display: inline">
                    ...
                    <!-- course-display -->
                    <div class="course-list-wraper all-course container">
                        <h1 style="margin-bottom: -16px; font-size: 32px;">
                            @if ($search)
                                <a href="/shop">
                            ...
                            @elseif ($categoryName)
                                <a href="/shop?category={{ $category }}">
                                    Danh Sách Khóa Học {{ $categoryName }}
                                </a>
                            @else
                                Tất cả khóa học
                            @endif
                        ...
                        <p style="margin-top: 32px;">Kho khóa học miễn phí với mọi kiến thức cũng như kỹ năng mà học
                            viên cần để gặt hái thành công, tiền bạc trên con đường sự nghiệp và cuộc sống!
                                        ...
                                        @if (is_array($element))
                                            @foreach ($element as $page => $url)
                                                <li class="page-item {{ $page == $products->currentPage() ? 'active' : '' }}">
                                                    <a class="page-link" href="{{ $url }}" style="color: black;">{{ $page }}</a>
                                                </li>
                                            @endforeach
                                        @endif
                                    @endforeach
