<div>
    <div>
        ...
        <body>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <ol class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li><a target="_self">Danh mục</a></li>
                                                <li><i class="fa fa-angle-right"></i></li>
                                                <li class="active">
                                                    <span>{{ $categoryInfo ? $categoryInfo->name : 'Tất cả' }}</span>
                                                </li>
                                            </ol>
                                        </div>
                                    </div>
                                        ...
                                        <aside class="col-sm-12">
                                            <div class="header-collection">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-lg-collection-left col-ld-css hidden-md hidden-sm hidden-xs clearfix">
                                                                            ...
                                                                            <div class="product-info">
                                                                                ...
                                                                                <div class="orderBox">
                                                                                    <div class="input-group glmama">
                                                                                        ...
                                                                                        <input type="hidden" class="zinzin" id="{{ $product->id }}" value="{{ $product->price }}">
                                                                                        <input type="text" class="form-control txtSl-{{ $product->id }} nani" value="1">
                                                                                        <span class="input-group-btn">
                                                        ...
                                                        <ul class="pagination">
                                                            <li class="page-item">
                                                                <a class="page-link" href="{{ $products->previousPageUrl() }}"
                                                                   aria-disabled="{{ $products->onFirstPage() }}">Previous</a>
                                                            </li>
                                                            ...
                                                            <li class="page-item">
                                                                <a class="page-link" href="{{ $products->nextPageUrl() }}"
                                                                   aria-disabled="{{ $products->hasMorePages() ? '' : 'true' }}">Next</a>
                                                            </li>
                                                        </ul>
                                                    </nav>
                                                    </div>
                            ...
                            <div class="wrapper-filter">
                                ...
                                <div class="filter-box-scroll">
                                    ...
                                    <div class="filter-box">
                                        <p aria-expanded="false" class="menu-link-filter">Danh mục<i
                                                class="fa fa-angle-down hidden-lg"></i></p>
            ...
            <script src='//theme.hstatic.net/200000077081/1001259549/14/lazysizes.min.js?v=168'
                type='text/javascript'></script>
