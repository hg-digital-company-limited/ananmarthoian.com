        ...
        <div>
            <div>
                ...
                <div class="flexbox">
                    ...
                    <head>
                        <title>
                            THANH TOÁN ĐƠN HÀNG - AN AN MART
                        </title>
                        ...
                        <div class="banner">
                            <div class="wrap">
                                <a href="/" class="logo">
                                    ...
                                    <h1 class="logo-text">AN AN MART - THANH TOÁN</h1>
                                                            ...
                                                            @if ($user)
                                                                <div class="logged-in-customer-information-avatar-wrapper">
                                                                    <div class="logged-in-customer-information-avatar gravatar"
                                                                        style="background-image: url(//www.gravatar.com/avatar/{{ md5($user->email) }}?s=100&d=blank);">
                                                                    </div>
                                                                </div>
