                                            ...
                                            <div id="recover-password" style="display:none;" class="userbox">
                                                ...
                                                <form accept-charset='UTF-8' action='/account/recover' method='post'>
                                                    ...
                                                    <input name='__RequestVerificationToken' type='hidden'
                                                        value='CfDJ8FyFPV59mBtNhmQGz0fYZt-Ie3Klgr43BPfGNEfmw4TAPx73A_ykJ8Gs1BDLCpnWL-Q1nic7KZn9ASydVjXlBUravp0u-7XEgK2vDW_Jbkgh1rhytz3AVnCm-NbGAdB9WIhDAp0lm85Srn4JxreO3sE'>
                                                    ...
                                                    <div class="input-group input-account mb15">
                                                        ...
                                                        <input type="email" name="email" id="recover-email"
                                                            placeholder="Email" class="form-control" size="30" />
                                                    </div>
                                                    <div class="action_bottom mb15">
                                                    ...
                                                    <input id='94f4969137484f6c918dac13542a6329'
