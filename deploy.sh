...
PROJECT_DIR="/var/www/ananmarthoian.com"
GIT_REPO="https://github.com/hg-digital-company-limited/ananmarthoian.com.git"
SQL_FILE="${PROJECT_DIR}/ananmarthoian.sql"
DB_NAME="ananmarthoian"
DB_USER="ananmarthoian"
DB_PASSWORD="ananmarthoian"  # Thay đổi mật khẩu nếu cần
